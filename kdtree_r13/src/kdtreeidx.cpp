...
*/
#define DEBUG            //General input-output debugging information
//#define DEBUG_BUILD_TREE  //Follow how the k-D tree is being built.
//#define DISPLAY_TREE      //Output the tree in a depth first traversal
//#define DEBUG_RUN_QUERIES //Follow the tree querying process

//#define TIME             //Find out how long it takes to build the k-D tree
                         //and to perform queries.
